 ...
 * Notes component
 */
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('note', {
 ...
 * Notes component
 */
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('notes', {
    template: '<ul class="notes__list">' + '<li class="notes__list__items" v-for="(note, index) in notes" @click="openModal(note)">' + '<div class="text" v-html="note" ></div>' + '</li>' + '</ul>',
    ...
    methods: {
        ...
        openModal: function openModal(note) {
            console.log(note);
